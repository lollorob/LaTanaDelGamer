...
INSERT INTO Categoria VALUES ("Sparatutto","Videogiochi in cui l'azione predominante ÃƒÂ¨ sparare con diversi tipi di armi");
INSERT INTO Categoria VALUES ("RPG","Videogiochi dove i giocatori assumono il ruolo di uno o piÃƒÂ¹ personaggi e tramite la conversazione e lo scambio dialettico creano uno spazio immaginato, dove avvengono fatti ed eventi fittizi, in un'ambientazione narrativa che puÃƒÂ² ispirarsi a un romanzo, a un film o a un'altra fonte creativa, storica, realistica come nella vita reale o di pura invenzione.");
INSERT INTO Categoria VALUES ("Simulazione","Videogiochi in cui si cerca di simulare un aspetto della realtÃƒÂ  e in genere richiede un misto di abilitÃƒÂ , fortuna e strategia. Si cerca per quanto possibile di riprodurre l'esperienza reale come se il giocatore fosse veramente nella situazione rappresentata");
...
INSERT INTO Categoria VALUES ("Casual","Videogiochi caratterizzati da un regolamento molto semplice e dal minore impegno richiesto per il loro utilizzo.Non richiedono particolari abilitÃƒÂ  o concentrazione.");
INSERT INTO Categoria VALUES ("MMO","Videogiochi di ruolo per computer o console che viengono svolti tramite Internet contemporaneamente da piÃƒÂ¹ persone reali.Migliaia di giocatori possono interagire interpretando personaggi che si evolvono insieme al mondo persistente che li circonda e in cui vivono.");
...
INSERT INTO Categoria VALUES ("Sportivi","Videogiochi che simulano, in maniera piÃƒÂ¹ o meno realistica, discipline sportive sia di squadra che individuali: tra gli sport piÃƒÂ¹ presenti vi sono baseball, calcio, automobilismo, motociclismo, football americano, pallacanestro, tennis, golf, hockey, lotta e pugilato.");
INSERT INTO Categoria VALUES ("Strategia","Videogiochi nei quali le capacitÃƒÂ  di prendere decisioni di un giocatore hanno un grande impatto nel determinare il risultato. Molti giochi includono questo elemento in grado minore o maggiore, rendendo difficile stabilire una demarcazione, ÃƒÂ¨ pertanto piÃƒÂ¹ adeguato parlare del grado di strategia di un gioco, piuttosto che del fatto che sia o meno un gioco di strategia. ");
INSERT INTO Categoria VALUES ("Corsa","Videogiochi in cui il giocatore deve pilotare un veicolo, ad esempio auto o moto, in un'ambientazione virtuale. I software cercano di rappresentare le varie gare di corse motoristiche piÃƒÂ¹ o meno fedelmente, spesso simulando con un motore fisico in modo molto complesso il comportamento reale di un veicolo in ogni situazione.");
INSERT INTO Categoria VALUES ("Picchiaduro","Videogiochi dove lo scopo principale ÃƒÂ¨ quello di affrontare i nemici in incontri di lotta di vario genere, sia a mani nude che attraverso l'utilizzo di armi da mischia.  ");
INSERT INTO Categoria VALUES ("Gestionali","Videogiochi che simulano azioni della vita quotidiana e richiedono al giocatore il controllo completo su una certa attivitÃƒÂ . ");
...
INSERT INTO Prodotto VALUES (5,"The Witcher 3",15.27,"In The Witcher si indossano i panni di un esperto cacciatore di taglie, Geralt di Rivia, incaricato di trovare una ragazza oggetto di una profezia in un universo fantasy aperto ricco di citta' mercantili, isole abitate da pirati vichinghi, pericolosi valichi di montagna e caverne da esplorare.","CD Project",5,"","RPG");
INSERT INTO Prodotto VALUES (6,"Farming Simulator 22",40.99,"Con Farming Simulator 22, inizia la tua impresa agricola in uno dei quattro dettagliati ambienti europei e americani, dove potrai cimentarti con le coltivazioni, la silvicoltura e l'allevamento. Sono a tua disposizione piu' di 500 macchinari e attrezzi autentici di oltre 100 celebri marchi da tutto il mondo.","Giants Software",5,"","Simulazione");
INSERT INTO Prodotto VALUES (7,"The Chant",40.98,"Un gioco di azione/avventura horror in terza persona per giocatore singolo, ambientato in un'isola remota durante un ritiro spirituale.","PrimeMatter",6,"","Azione");
INSERT INTO Prodotto VALUES (8,"Deathloop - Deluxe Edition",69.99,"Nei panni di Colt, i giocatori sono intrappolati in un loop temporale sulla misteriosa isola di Blackreef, condannata a rivivere lo stesso giorno in eterno. L' unica possibilita' di fuga e' spezzare il loop scoprendo utili informazioni e assassinando otto bersagli chiave prima che il giorno si azzeri.","Bethesda Softworks",6,"","Avventura");
INSERT INTO Prodotto VALUES (9,"Life is Strange: True Colors",34.99,"Un nuovo capitolo della pluripremiata serie Life is Strange ha inizio, con una nuova protagonista e un elettrizzante mistero da risolvere!Alex Chen ha sempre nascosto la sua maledizione: l'abilita' sovrannaturale di percepire, assorbire e manipolare le emozioni piu' intense delle altre persone, che lei vede come delle aure colorate.","SquareEnix",2,"","Azione");
INSERT INTO Prodotto VALUES (10,"Biomutant",39.98,"BIOMUTANT e' un RPG open-world post apocalittico, con tecniche uniche di arti marziali che uniscono combattimenti corpo a corpo ad armi da fuoco e abilita' da mutante.","THQ Nordic",4,"","Azione");
INSERT INTO Prodotto VALUES (11,"MotoGP 21",19.99,"Proprio come i veri piloti, anche tu dovrai seguire le regole del campionato ufficiale, o ne affronterai le conseguenze tra le quali, per la prima volta, il Long Lap Penalty. Divertiti con l'esperienza di MotoGP piu' autentica che mai!","Milestone",4,"","Corsa");
INSERT INTO Prodotto VALUES (12,"HITMAN 3",29.99,"HITMAN 3 e' la drammatica conclusione della trilogia del mondo degli assassini e porta i giocatori in giro per il mondo in un'avventura attraverso vaste locations sandbox.","SquareEnix",8,"","Azione");
INSERT INTO Prodotto VALUES (13,"Expeditions Rome",29.99,"Il futuro di Roma e' nelle tue mani: come passerai alla storia? Impersona un giovane Legato, fuggito da Roma dopo l'assassinio del padre per mano di un avversario politico ignoto e costretto a unirsi a una campagna militare per sedare una rivolta greca.","THQ Nordic",4,"","Strategia");
INSERT INTO Prodotto VALUES (14,"Outriders - Day One Edition",14.99,"Outriders e' uno shooter GdR cooperativo da 1 a 3 giocatori ambientato in un universo fantascientifico oscuro e spietato.","Square Enix",4,"","Sparatutto");
INSERT INTO Prodotto VALUES (15,"Empire of Sin",15.00,"Empire of Sin ti trasporta nello spietato mondo del crimine della Chicago proibizionista degli anni '20. Stara' a te usare una combinazione di fascino e intimidazione per scalare le gerarchie della malavita","Paradox Interactive",3,"","RPG");
INSERT INTO Prodotto VALUES (16,"Cyberpunk 2077",89.98,"Cyberpunk 2077 e' un'avventura a mondo aperto ambientata a Night City, una megalopoli ossessionata dal potere, dalla moda e dalle modifiche cibernetiche. Vestirai i panni di V, un mercenario fuorilegge alla ricerca di un impianto unico in grado di conferire l'immortalita'.","CD Project",6,"","RPG");
INSERT INTO Prodotto VALUES (17,"Marvel's Avengers",15.99,"Riunisci la squadra degli eroi piu' potenti della Terra, scatena i tuoi poteri e vivi il tuo sogno di supereroe.Marvel Entertainment e Square Enix sono orgogliose di presentare Marvel's Avengers, un epico gioco di azione-avventura che combina una narrazione cinematografica con meccaniche di gioco in solitario e cooperativo.","Square Enix",5,"","Azione");
INSERT INTO Prodotto VALUES (18,"Fallout 76 - Wastelanders",14.98,"In Fallout 76: Wastelanders, la Virginia Occidentale torna a popolarsi. Due fazioni sono in lizza per ottenere il controllo della Virginia Occidentale mentre ne scoprono i segreti. I coloni sono alla ricerca di una nuova casa, mentre i predoni vogliono sfruttarne gli sforzi.","Bethesda Softworks",8,"","Avventura");
INSERT INTO Prodotto VALUES (19,"Desperados III",2.98,"Desperados III e' un moderno gioco tattico in tempo reale ambientato in uno spietato e selvaggio West.Trasforma una banda sgangherata in un efficiente gruppo di improbabili eroi ed eroine.","THQ Nordic",2,"","Strategia");
INSERT INTO Prodotto VALUES (20,"Detroit Become Human",12.99,"E' l'anno 2038. Questa e' la storia di Kara.Scrivi il futuro.Immergiti in una visione inquieta della Detroit del futuro, dove umani e androidi conducono una fragile convivenza e le tue decisioni costruiscono la storia che ti circonda.","Quantic Dreams",4,"","Azione");
INSERT INTO Prodotto VALUES (21,"Football Manager 2023",60.99,"In Football Manager 2023 non basta scegliere le tattiche e costruire una squadra. Devi affrontare sfide e farti largo per imporre il tuo stile.Guida la tua squadra con un livello di profondita' senza uguali. Scrivi la tua storia e diventa un allenatore di successo conquistando la fiducia e il rispetto dei tifosi e dominando sul campo.","Sega",2,"","Simulazione");
INSERT INTO Prodotto VALUES (22,"Pro Cycling Manager 2022",34.99,"Con Pro Cycling Manager 2022 vestirai i panni di un direttore sportivo. Prendi tutte le decisioni necessarie per portare la tua squadra alla vetta: le tue responsabilita' includono il reclutamento, la pianificazione degli obiettivi e dei programmi di gara, la gestione degli sponsor, lo scouting dei futuri talenti, l'allenamento, la strategia di gara e molto altro.","Nacon",1,"","Simulazione");
INSERT INTO Prodotto VALUES (23,"Beyond Two Souls",4.99,"Dai creatori del premiato Heavy Rain arriva un nuovo thriller psicologico interattivo con protagoniste le star di Hollywood Ellen Page e Willem Dafoe. Vesti i panni di Jodie Holmes, una ragazza con poteri soprannaturali derivati dal legame psichico con un'entita' invisibile.Vivi i momenti piu' profondi della vita di Jodie in un arco di tempo di 15 anni, dall'infanzia confusa fino all'ingresso nella CIA, e scopri chi e' realmente.","Quantic Dreams",7,"","Azione");
INSERT INTO Prodotto VALUES (24,"The Surge",49.99,"Un evento catastrofico ti ha fatto perdere i sensi al primo giorno di lavoro... Ti sei svegliato in un avveniristico esoscheletro in un'area distrutta del complesso. Robot impazziti, una sadica intelligenza artificiale e colleghi psicopatici e dai poteri sovrumani ti aspettano per ucciderti.Sconfiggi nemici letali e imponenti boss in scontri corpo a corpo brutali e tesissimi.","Focus Home Interactive",8,"","Azione");
INSERT INTO Prodotto VALUES (25,"Rime",39.98,"La storia di un ragazzo che usa l'intelligenza e l'ingegno per sopravvivere e infine fuggire da un'isola misteriosa e da una maledizione terribile.Una fine e un nuovo inizio.Un'isola misteriosa con un segreto sinistro e un'avventura open-world un po' diversa","Greybox",4,"","Avventura");
INSERT INTO Prodotto VALUES (26,"Call of Duty: Black Ops III",49.96,"Diamo il benvenuto a Call of Duty: Black Ops 3, un oscuro e drammatico futuro dal quale emerge una nuova tipologia di soldati Black Ops e dove il confine tra la nostra umanita' e la nostra tecnologia si assottiglia sempre di piu', in un mondo dove la guerra si combatte con la corsa alla robotica militare piu' avanzata.","Activision",3,"","Sparatutto");
INSERT INTO Prodotto VALUES (27,"DayZ",9.98,"DayZ e' un gioco di sopravvivenza estrema open world con una regola: sopravvivere a tutti i costi. Ma, data la miriade di minacce in agguato, e' piu' facile a dirsi che a farsi...","Bohemia Interactive",5,"","Indie");
INSERT INTO Prodotto VALUES (28,"SpeedRunners",3.50,"SpeedRunners e' un gioco a piattaforme competitivo per 4 giocatori con rampini, potenziamenti, e ambienti interattivi. Corri, salta, oscilla intorno, spara razzi, usa i rampini sulla gente per buttarla fuori dallo schermo.","TinyBuild",3,"","Casual");
INSERT INTO Prodotto VALUES (29,"World Of Warcraft: Dragonflight",49.99,"World of Warcraft e' l'MMO piu' giocato al mondo,World of Warcraft e' ambientato nell'universo di Warcraft, e riprende l'omonima serie di videogiochi strategici in tempo reale.","Blizzard",2,"","MMO");
